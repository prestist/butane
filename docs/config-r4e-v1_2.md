...
title: RHEL for Edge v1.2.0
parent: Configuration specifications
nav_order: 197
---

# RHEL for Edge Specification v1.2.0
...
* **version** (string): the semantic version of the spec for this document. This document is for version `1.2.0` and generates Ignition configs with version `3.5.0`.
