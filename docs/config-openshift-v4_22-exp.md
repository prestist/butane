...
* **version** (string): the semantic version of the spec for this document. This document is for version `4.22.0-experimental` and generates Ignition configs with version `3.6.0`.
